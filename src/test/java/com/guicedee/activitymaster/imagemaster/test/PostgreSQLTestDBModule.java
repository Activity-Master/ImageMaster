...
/**
 * Testcontainers-backed PostgreSQL persistence unit for the Image Master integration tests.
 *
 * <p>Boots a throwaway PostgreSQL instance, applies the canonical FSDM schema scripts
 * ({@code postgres_fsdm.sql} + {@code postgres_structure.sql}) and exposes it as the default
 * {@code ActivityMaster-Test} entity manager — exactly the unit the rest of the ActivityMaster
 * reactive stack binds to.</p>
 */
